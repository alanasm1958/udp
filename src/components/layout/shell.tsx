...
const navigation: NavItem[] = [
  ...
  // 5. Operations Hub (Unified: Inventory + Procurement + Service Fulfillment)
  {
    label: "Operations",
    href: "/operations",
    icon: (
  ...
  // 8. Company Profile & Configuration
  {
    label: "Company",
    href: "/company",
    icon: (
    ...
    children: [
      ...
      { label: "Master Data", href: "/company/master" },
  ...
  // 9. Governance, Risk & Compliance
  {
    ...
    children: [
      { label: "Overview", href: "/grc" },
      { label: "Alerts", href: "/grc/alerts" },
      { label: "Audit Log", href: "/grc/audit" },
    ],
  },
];
