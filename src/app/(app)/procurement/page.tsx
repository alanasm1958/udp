...
export default function ProcurementPage() {
  ...
  const [data, setData] = React.useState<PurchaseDocsResult | null>(null);
  ...
  const loadData = React.useCallback(async () => {
    ...
    try {
      ...
      const result = await apiGet<PurchaseDocsResult>(`/api/procurement/docs?${params}`);
      setData(result);
    } catch (err) {
