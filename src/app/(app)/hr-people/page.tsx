      ...
      <div>
        ...
        {isLoading ? (
          ...
          <GlassCard className="p-8 text-center">
            <p className="text-white/40">No analytics data available yet. Start by adding persons to your organization.</p>
          </GlassCard>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <GlassCard>
          ...
          <div className="p-6">
            {isLoading ? (
              ...
              <p className="text-white/40 text-center py-8">No pending tasks</p>
            ) : (
              <div className="space-y-3">
                {todos.map((todo) => (
                  <div
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {accessCards.map((card, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 rounded-lg bg-white/5">{card.icon}</div>
