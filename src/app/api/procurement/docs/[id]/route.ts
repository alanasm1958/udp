...
export async function PATCH(
  ...
  try {
    ...
    const body: UpdatePurchaseDocRequest = await req.json();
    ...
    await audit.log("purchase_doc", updated.id, "purchase_doc_updated", {
    ...
    console.error("PATCH /api/procurement/docs/[id] error:", error);
