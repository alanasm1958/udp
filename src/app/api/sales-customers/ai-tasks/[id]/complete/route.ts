/**
 * /api/sales-customers/ai-tasks/[id]/complete
 *
 * Complete an AI sales task
 */
...
/**
 * POST /api/sales-customers/ai-tasks/[id]/complete
...
export async function POST(
  ...
  try {
    ...
    const body: CompleteRequest = await req.json().catch(() => ({}));
    ...
    console.error("POST /api/sales-customers/ai-tasks/[id]/complete error:", error);
