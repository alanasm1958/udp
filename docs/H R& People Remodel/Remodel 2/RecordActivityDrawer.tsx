// components/hr/RecordActivityDrawer.tsx
"use client";
...
export default function RecordActivityDrawer({
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case "performance":
        // TODO: Implement performance review form
        return (
          <div className="p-6">
            <p className="text-white/60">Performance review form coming soon...</p>
          </div>
        );
  ...
  return (
    <SlideOver
      ...
      onClose={onClose}
      title={getTitle()}
      size={activeView === "menu" ? "default" : "large"}
    >
      {renderContent()}
    </SlideOver>
  );
